...
<body class="login">
    ...
    include 'loginmenu.php';
        ...
        <div class="login-area">
                <h2 class="bg-light">REGISTER</h2>
                <div class="form-group">
                <form action="" method="post">
                <input type="text" name="name" class="form-control" placeholder="Name" required>
                <input type="text" name="email" class="form-control" placeholder="Email Address" required>
                <input type="text" name="password" class="form-control" placeholder="Password" required>
                <input type="text" name="compass" class="form-control" placeholder="Confirm Password" required>
    ...
    if(isset($_POST['submit'])){
        ...
        //  !is_empty($password) && !is_empty($compass) &&
        //  !is_empty($bio)){
        // not working


        //  if (!is_null($name) && !is_null($email) &&
        //  !is_null($password) && !is_null($compass) &&
        //  !is_null($bio)){
        // not working
        ...
        if ($conn->query($sql2) == TRUE) {            
            ...
            echo 'ERROR! You should confirm Password again.';
        }
    // }else{
    //         echo 'ERROR! Some area is blank.';
        // }
